...
class Dataset_Intraday(Dataset):
...
class Dataset_Interday(Dataset):
    def __init__(self, root_path, size, flag='train', data_path=None, train_only=False, return_date=False, data_segment=None, stocks=None):
...
def data_provider(args, flag, return_date=False):
    ...
    if args.dataloader_type == 'intraday':
        Data = Dataset_Intraday
    elif args.dataloader_type == 'interday':
        Data = Dataset_Interday
    else:
